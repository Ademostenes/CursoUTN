...
public class Menu {
    ...
    public Menu(){
     			...
     			try {
     				equipo = archivo.leerCsv();
     					if (equipo.size()<= 32){
     						...
     						System.out.println("Se ha alcanzado el nÃºmero mÃ¡ximo de equipos!");
            		} }	catch (IOException e) {
        ...
        public static void modificarEquipos(){
           ...
           try {
        	   equipo = archivo.leerCsv();
       System.out.print("Ingrese el nÃºmero de ID del equipo a modificar:");
       ...
       if (id > 0 && id < 33){
        ...
        System.out.print("Ingrese el nÃºmero correspondiente a su usuario: ");
        ...
        try {
        	jugador = archivo.leerJugadores();
                do {
            System.out.print("Ingrese el nÃºmero de DNI del nuevo Jugador:");
        ...
        jugador.add(jug);
        System.out.println();
        System.out.print("Desea continuar cargando jugadores? 1: SÃ­ | 0: No |:");
        ...
        public static void listarJugXPuntos() {
        	...
        	List<Integer> jugaOrden = new ArrayList<Integer>();
        		...
        		List<Integer> ordenada = jugaOrden.stream().sorted(Collections.reverseOrder()).collect(Collectors.toList());
        		for (int k = 0; k<ordenada.size(); k++) {
        			for (int h = 0; h<ordenada.size(); h++) {
        				if (jugadores.get(h).getPuntosJ() == ordenada.get(k)) {
     ...
     public static void menuJugadores() {
        	...
        	System.out.println(" |-----------------------|");
        	System.out.println();
        	System.out.print("Ingrese el nÃºmero de la opciÃ³n deseada: ");
        	opt = Integer.parseInt(leer1.nextLine());
        	switch (opt) {
        ...
        public static void eliminarJugador() {
        	...
        	try {
        		...
        		if (existe) {
        			...
        			System.out.println("estÃ¡ por ser eliminado, confirma la operaciÃ³n? Ingrese 1 para confirmar. Cualquier otro para desistir.");
        			...
        			if (opt == 1) {
        				...
        				System.out.println("EliminaciÃ³n cancelada. Presione ENTER para salir.");
        				leer.nextLine();
        			}
        		} else {
        			System.out.println();
